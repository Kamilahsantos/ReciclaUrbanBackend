...
public class Residence {
  ...
  public Residence(Long id, String name, String address, String telephone, String score, String username, String email, String password) {
    this.id = id;
    this.name = name;
    this.address = address;
    this.telephone = telephone;
  ...
  public String toString() {
    return "Residence [id=" + id + ", name=" + name + ", address=" + address + ", telephone=" + telephone + ", score=" +score + ", username=" +username
      + ", password=" + password    + "]";
  }
